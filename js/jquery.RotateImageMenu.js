			...
			var	timeDiff			= 100,
				...
				*/
				...
				rotateMaskCorners	= function() {
					$rm_mask_left.transform({rotate: '0deg'});
					$rm_mask_right.transform({rotate: '0deg'});
					$rm_corner_left.transform({rotate: '0deg'});
					$rm_corner_right.transform({rotate: '0deg'});
				},
