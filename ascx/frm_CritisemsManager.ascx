<%@ Control Language="C#" AutoEventWireup="true" CodeFile="frm_CritisemsManager.ascx.cs" Inherits="ascx_frm_critisems" %>
<div dir="rtl">
<div>
...
<div>
    ...
    <asp:ObjectDataSource ID="ods_cr" runat="server" DeleteMethod="Delete" 
        InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="GetData" 
        TypeName="MainDataModuleTableAdapters.tbl_criticismsTableAdapter" 
        ...
        <InsertParameters>
            <asp:Parameter Name="کد" Type="Int32" />
            ...
            <asp:Parameter Name="کد_کاربری" Type="Int32" />
